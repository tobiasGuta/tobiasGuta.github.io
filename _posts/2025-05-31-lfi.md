...
Local File Inclusion is a vulnerability where a web app lets a user include files on the **server**, either for viewing or execution. It's often caused by **improper input sanitization** when user-controlled data is used in file path functions like:
